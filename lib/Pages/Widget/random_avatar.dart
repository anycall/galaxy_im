...
String RandomAvatarString(String string, {bool trBackground = false}) {
  ...
  //方形
  String env = '<rect x="0" y="0" width="231" height="231" rx="15" ry="15" style="fill:#01;"/>';
  //圆形
  ...
  sP['01']?['head'] = head;
  sP['01']?['mouth'] =
      '<path d="m100.35 143.85a7.67 7.67 0 0 0 7.58 7.7v0a7.66 7.66 0 0 0 7.57-7.7 7.66 7.66 0 0 0 7.57 7.7v0a7.67 7.67 0 0 0 7.58-7.7" style="fill:none;${str}6.3998px;stroke:#333;"/>';
  sP['01']?['eyes'] =
      '<path d="m78.73 111a10.9 10.9 0 0 1 15.19 0m43.16 0a10.9 10.9 0 0 1 15.19 0" style="fill:none;${str}6.1999px;stroke:#333;"/><path d="m79.804 123.74h7.07m57.273 0h7.05" style="fill:none;${str}5.9998px;stroke:#b8b8b8;"/>';
  sP['01']?['top'] =
  ...
  sP['03']?['head'] = head;
  sP['03']?['mouth'] =
      '<path d="m136.21 147.09a21.77 21.77 0 0 1-40.13 0z" style="fill:#fff;${str}3.4999px;stroke:#000;"/>';
  sP['03']?['eyes'] =
      '<path d="m145.39 104.7-11.52 11.2h17.26m-65.52-11.2 11.52 11.2h-17.26" style="fill:none;${str}5.4998px;stroke:#000;"/>';
  sP['03']?['top'] =
  ...
  sP['04']?['eyes'] =
      '<path d="m131.64 114.09 7.5801-7.5801 7.5801 7.5801m-62.6 0 7.5801-7.5801 7.5799 7.5801" style="fill:none;${str}6.4998px;stroke:#000;"/>';
  sP['04']?['top'] =
  ...
  sP['05']?['head'] = head;
  sP['05']?['mouth'] =
      '<path d="m122.83 151.88a10.49 10.489 0 0 1-14.66 0" style="fill:none;${str}6.1996px;stroke:#333;"/>';
  ...
  sP['06']?['head'] = head;
  sP['06']?['mouth'] =
      '<path d="m127.84 146.73c-2.24 8.93-6.92 15.08-12.34 15.08s-10.1-6.15-12.34-15.08z" style="fill:#fff;${str}2.9999px;stroke:#1a1a1a;"/>';
  sP['06']?['eyes'] =
      '<path d="m129.31 114.14 20-5.37m-47.66 5.37-20-5.37" style="fill:none;${str}4.9998px;stroke:#1a1a1a;"/>';
  sP['06']?['top'] =
  ...
  sP['07']?['head'] = head;
  sP['07']?['mouth'] =
      '<polygon points="121.61 160.74 109.39 160.74 115.5 171.31" style="fill:#797979;"/><path d="m132.64 144.06a34.42 34.42 0 0 1-34.24 0" style="fill:none;${str}5.9998px;stroke:#000;"/>';
  sP['07']?['eyes'] =
  ...
  sP['09']?['head'] = head;
  sP['09']?['mouth'] =
      '<path d="m126.28 149.82c-6.16 2.43-15.52 2.42-21.56 0" style="fill:none;${str}5.9998px;stroke:#1c1c1c;"/>';
  sP['09']?['eyes'] =
  ...
  sP['13']?['eyes'] =
      '<path d="m91.72 97.36v11.4m47.56-11.4v11.4" style="fill:none;${str}7.9999px;stroke:#333;"/>';
  sP['13']?['top'] =
  ...
  sP['14']?['eyes'] =
      '<path d="m133 108.17h14.17m-63.26 0h14.09m-20.69-8.93a21.31 21.31 0 0 1 27.29 0m21.8 0a21.31 21.31 0 0 1 27.29 0" style="fill:none;${str}4.8243px;stroke:#000;"/>';
  ...
  p['env'] = '${hash[0]}${hash[1]}';
  p['env'] = '${((47 / 100) * int.parse(p['env'])).round()}';

  p['clo'] = '${hash[2]}${hash[3]}';
  p['clo'] = '${((47 / 100) * int.parse(p['clo'])).round()}';

  p['head'] = '${hash[4]}${hash[5]}';
  p['head'] = '${((47 / 100) * int.parse(p['head'])).round()}';

  p['mouth'] = '${hash[6]}${hash[7]}';
  p['mouth'] = '${((47 / 100) * int.parse(p['mouth'])).round()}';

  p['eyes'] = '${hash[8]}${hash[9]}';
  p['eyes'] = '${((47 / 100) * int.parse(p['eyes'])).round()}';

  p['top'] = '${hash[10]}${hash[11]}';
  p['top'] = '${((47 / 100) * int.parse(p['top'])).round()}';
