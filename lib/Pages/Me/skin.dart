      ...
      body: Center(
        child: Column(
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                Helper.themeManager.updateColorScheme(false, colorScheme:const ColorScheme.light() );
              },
              child: Text("白天"),
            ),
            const SizedBox(height: 10),
            ElevatedButton(
              onPressed: () {
                                Helper.themeManager.updateColorScheme(false, colorScheme:const ColorScheme.dark() );
              },
              child: Text("黑天"),
            ),
          ],
